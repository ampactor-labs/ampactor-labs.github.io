...
const PROJECTS = [
  ...
  { id: "x402-rs", title: "X402-RS", subtitle: "PAYMENTS OVER HTTP", lang: "Rust", color: "#44aaff", icon: "\u27d0", github: "https://github.com/ampactor/x402-rs", desc: "x402 payment protocol in Rust. Verify, settle, and monitor payments over HTTP 402 flows. The internet's missing payment layer.", tags: ["x402", "http", "payments", "protocol"] },
  ...
  { id: "x402", title: "X402", subtitle: "PAYMENT PROTOCOL", lang: "TypeScript", color: "#aa66ff", icon: "\u25c9", github: "https://github.com/ampactor/x402", desc: "Payments protocol for the internet built on HTTP. Fork of the Coinbase reference implementation.", tags: ["coinbase", "http402", "web3", "protocol"] },
